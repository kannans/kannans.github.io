    ...
    return (
      <div>
        <Grid>
          ...
          <Col xs={12} md={3}>
            <Image src="http://kannansv.in/assets/me.jpg" circle responsive />
          ...
          <Col xs={12} md={7}>
            ...
            <p>
              ...
              <strong> Ruby On Rails</strong>, ReactJS, AngularJS, HTML5, CSS3, JQuery, Responsive Design.
            </p>
          </Col>
        </Row>
        ...
        <footer className="footer">
          <div className="container">
            <p className="text-muted">© 2016 Kannansv.in. All Rights Reserved.</p>
          </div>
        </footer>
      </div>
    )
