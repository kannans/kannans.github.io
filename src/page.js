        ...
        return (
            <div className="android-content mdl-layout__content">
              ...
              <div className="android-be-together-section mdl-typography--text-center">
                ...
                <div className="logo-font android-sub-slogan">welcome to android... be yourself. do your thing. see whats going on.</div>
                  ...
                  <div className="android-wear-band-text">
                    ...
                    <p>
                      <a className="mdl-typography--font-regular mdl-typography--text-uppercase android-alt-link" href="">
                        See whats new in the Play Store&nbsp;<i className="material-icons">chevron_right</i>
                      </a>
                    </p>
                  </div>
                </div>
